...
const CalendarHeader = ({ startDate, weekDates, handleChangeStartDate }) => {
  ...
  return (
    <HeaderWrapper>
      <div className="prev-2days-icon" onClick={() => navigate2Days(-1)} style={{borderColor: startDate.isSame(new Date(), 'day') ? "#aaaaaa" : "#173FD4"}}>
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M19 12L5.28572 12" stroke={startDate.isSame(new Date(), 'day') ? "#aaaaaa" : "#173FD4"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M11.2852 18L5.28516 12L11.2852 6" stroke={startDate.isSame(new Date(), 'day') ? "#aaaaaa" : "#173FD4"}  strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      </div>

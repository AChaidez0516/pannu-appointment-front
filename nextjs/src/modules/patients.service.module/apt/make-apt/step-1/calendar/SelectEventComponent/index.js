        ...
        <div className="list-body">
          {events.map(event => (
            <div key={event.id} className="row">
              <div className="event" onClick={() => setSelectedEvent(event)}>{`${event.format("hh:mm A")} ${event.format("dddd")} ${event.format("MM/DD/YYYY")}`}</div>
              <div className="action-wrapper">
                <div className="to-select">
                  <div className='option-unit'>
                    <div className='option-field'>
                      <Image
                        src={selectedEvent && selectedEvent.isSame(event) ? ICONS.radioOn : ICONS.radioOff}

...
import { SearchIcon } from '../../../../../common/utils/Icons'
...
export default function AddReasonsInModalComponent(props) {
  const {
    setIsDisabled,
    reasons,
    setReasons,
  ...
  return (
    <ReasonListWrapper>
      <div className="title">Select from new reasons for this visit</div>

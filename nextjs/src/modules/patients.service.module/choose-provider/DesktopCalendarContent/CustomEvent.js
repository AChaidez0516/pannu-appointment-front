  ...
  return(
    <CardContentWrapper>
      ...
      <EndWrapper>
        <span>MD BC</span>
        <div>
          <label><Image src={ICONS.camera} width={11} height={6} /></label>
          <label><Image src={ICONS.linePhone} width={9} height={9} /></label>
          <label><Image src={ICONS.mobilePhone} width={6} height={9} /></label>
        </div>
      </EndWrapper>

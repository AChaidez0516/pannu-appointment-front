        ...
        <>
          ...
          <FilterWrapper>
            ...
            <div
              ...
              onClick={(e) =>
                setQrPopupOptions({ opened: true, anchorEl: e.currentTarget })
              }
            >
              <AvatarIcon />
            </div>
          ...
          <FilteredDisplayWrapper>
            <div className="selected-location">
              {locations.find((l) => l.id === filter.locationId)?.text ||
                "Location A"}
            </div>
          </FilteredDisplayWrapper>
          <Summary>
          ...
          <Row4>
            <SelectPopup
              ...
              items={virtualVisitItems}
            ></SelectPopup>
            <div className="history" onClick={() => add()}>
              Add
            </div>
            <SelectPopup
              value={formData.aptWMD}
          ...
          <Row5>
            <div className="items">
              <div className="item">XXXXX</div>
              <div>
                <VectorIcon />
              </div>
            </div>
            <div className="items">
              <div className="item">XXX.XXX - XXX.XXX</div>
              <div>
                <VectorIcon />
              </div>
            </div>
          ...
          <Box mt={60} px={9}>
            <ActionBtnWrapper twoMoreBtns>
              <ActionBtn
                ...
                lineH={12}
                style={{ color: "black" }}
                onClick={() => goToDetails(aptDetails.id)}
              >
                Cancel
              </ActionBtn>
              <ActionBtn
...
export default AnotherAppointment;

...
export default class InfiniteScroll extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (this.props.forceRefresh === prevProps.forceRefresh) return;
  ...
  isElementAtBottom(
    ...
    if (threshold.unit === ThresholdUnits.Pixel) {
      // console.log('thresholdunits percent',
      //   target.scrollTop, clientHeight, threshold.value, target.scrollHeight)
  ...
  : document.documentElement.scrollTop
    ...
    /* changed by Tang 20200810
    /*let atBottom = this.props.inverse
    ...
    if (direction == 1 && atBottom && this.props.hasMoreAppend) {
      this.actionTriggered = true;
      this.setState({ showLoader: true });
      this.props.append && this.props.append();
    }

    if (direction == 2 && atTop && this.props.hasMorePrepend) {
      this.actionTriggered = true;
      this.setState({ showLoader: true });
